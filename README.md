...
**Console** — scriptets logoutput ved opstart (version, API-tid, URL, prisopdatering og prisopdeling):

![Console](https://raw.githubusercontent.com/DuckAvenger/shelly-elpris-dk/main/img/console.png)

**Status-siden** — viser aktuel pris (samlet og opdelt i spot/nettarif/energiafgift), output-tilstand, årsag samt oversigt og outputs for i dag og næste dag:

![Status-siden](https://raw.githubusercontent.com/DuckAvenger/shelly-elpris-dk/main/img/status.png)

**Opsætning-siden** — region, netselskab (med automatisk GLN-opslag) og styringstilstand:

![Opsætning-siden](https://raw.githubusercontent.com/DuckAvenger/shelly-elpris-dk/main/img/setup.png)
...
- Priser for næste dag udgives typisk af Nord Pool mellem kl. 13-16; indtil da viser Status-siden en informativ besked i stedet for tomme felter.
